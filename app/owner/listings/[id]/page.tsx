...
export default function OwnerDormPreviewPage() {
  ...
  const getListingTypeIcon = (type: string) => {
    ...
    if (t.includes('upper')) return <ChevronRight className="w-3.5 h-3.5 text-secondary -rotate-90" />;
    if (t.includes('lower')) return <ChevronRight className="w-3.5 h-3.5 text-secondary rotate-90" />;
    return <Home className="w-3.5 h-3.5 text-secondary" />;
  };

  return (
    <div className="min-h-screen bg-white relative pb-32">
      {/* Background Decor from Onboarding */}
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4">
        {/* Header - Matching Add Listing Style */}
        <div className="sticky top-0 bg-white/80 backdrop-blur-md z-30 py-6 mb-2">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-black text-neutral-dark mb-1 tracking-tight">Preview</h1>
              <p className="text-gray-500 font-bold text-[10px] uppercase tracking-[0.15em] opacity-60">How they see your property</p>
            </div>
            <button 
              onClick={() => router.back()}
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1 p-6 border-r border-gray-50">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-3xl font-black text-neutral-dark tracking-tighter">
                    ₱{Number(dorm.price).toLocaleString()}
                  </span>
...
{/* Core Info - Refined Typographic Layout */}
    ...
    <div className="flex-1 px-6 py-5">
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="text-[11px] font-black text-neutral-dark uppercase tracking-wider">
          ...
          {/* Features - Grid matching Step 3 Toggle style */}
          ...
          {/* Rules Section - Matching Inherited Rules card style */}
